...
ALTER TABLE [dbo].[Song]
    ADD CONSTRAINT [DF_Song_IsLocalFile] DEFAULT ((0)) FOR [IsLocalFile];
GO

ALTER TABLE [dbo].[Song]
    ADD CONSTRAINT [DF_Song_CreatedBy] DEFAULT (suser_sname()) FOR [CreatedBy];
GO

ALTER TABLE [dbo].[Song]
    ADD CONSTRAINT [DF_Song_CreatedUtc] DEFAULT (getutcdate()) FOR [CreatedUtc];
GO

ALTER TABLE [dbo].[Song]
    ADD CONSTRAINT [FK_Song_ServiceId] FOREIGN KEY ([ServiceId]) REFERENCES [dbo].[StreamingService] ([ServiceId]);
GO

ALTER TABLE [dbo].[Song]
    ADD CONSTRAINT [FK_Song_ProducerGroup] FOREIGN KEY ([ProducerGroupId]) REFERENCES [dbo].[ProducerGroup] ([ProducerGroupId]);
GO

ALTER TABLE [dbo].[Song]
    ADD CONSTRAINT [FK_Song_GenreId] FOREIGN KEY ([GenreId]) REFERENCES [dbo].[Genre] ([GenreId]);
GO

ALTER TABLE [dbo].[Song]
    ADD CONSTRAINT [FK_Song_GroupId] FOREIGN KEY ([GroupId]) REFERENCES [dbo].[Group] ([GroupId]);
GO

ALTER TABLE [dbo].[Song]
    ADD CONSTRAINT [FK_Song_SceneId] FOREIGN KEY ([SceneId]) REFERENCES [dbo].[Scene] ([SceneId]);
GO

ALTER TABLE [dbo].[Song]
    ADD CONSTRAINT [FK_Song_ProjectId] FOREIGN KEY ([ProjectId]) REFERENCES [dbo].[Project] ([ProjectId]);
GO

ALTER TABLE [dbo].[Song]
    ADD CONSTRAINT [CK_Song_Rating] CHECK ([Rating]>=(0.00) AND [Rating]<=(10.00));
GO

ALTER TABLE [dbo].[Song]
    ADD CONSTRAINT [CK_Song_Duration] CHECK ([Duration]>=(0));
GO

ALTER TABLE [dbo].[Song]
    ADD CONSTRAINT [PK_Song] PRIMARY KEY CLUSTERED ([SongId] ASC);
GO
