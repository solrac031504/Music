...
(
    ...
    , CONSTRAINT [PK_StreamingService] PRIMARY KEY CLUSTERED (ServiceId ASC)
);
GO
...
EXEC sys.sp_addextendedproperty
    @name = N'Description'
    , @value = N'The StreamingService streaming service source'
    , @level0type = N'SCHEMA'
    , @level0name = N'dbo'
    , @level1type = N'TABLE'
    , @level1name = N'StreamingService';
GO
...
EXEC sys.sp_addextendedproperty
    @name = N'MS_Description'
    , @value = N'The name of the source streaming service'
    , @level0type = N'SCHEMA'
    , @level0name = N'dbo'
    , @level1type = N'TABLE'
    , @level1name = N'StreamingService'
    , @level2type = N'COLUMN'
    , @level2name = N'ServiceName';
GO
