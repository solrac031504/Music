...
ALTER TABLE [dbo].[Scene]
    ADD CONSTRAINT [DF_Scene_CreatedBy] DEFAULT (suser_sname()) FOR [CreatedBy];
GO

ALTER TABLE [dbo].[Scene]
    ADD CONSTRAINT [DF_Scene_CreatedUtc] DEFAULT (getutcdate()) FOR [CreatedUtc];
GO

ALTER TABLE [dbo].[Scene]
    ADD CONSTRAINT [DF_Scene_IsGeographic] DEFAULT ((0)) FOR [IsGeographic];
GO

ALTER TABLE [dbo].[Scene]
    ADD CONSTRAINT [PK_Scene] PRIMARY KEY CLUSTERED ([SceneId] ASC);
GO
