...
ALTER TABLE [dbo].[Artist]
    ADD CONSTRAINT [DF_Artist_CreatedBy] DEFAULT (suser_sname()) FOR [CreatedBy];
GO

ALTER TABLE [dbo].[Artist]
    ADD CONSTRAINT [DF_Artist_CreatedUtc] DEFAULT (getutcdate()) FOR [CreatedUtc];
GO

ALTER TABLE [dbo].[Artist]
    ADD CONSTRAINT [PK_Artist] PRIMARY KEY CLUSTERED ([ArtistId] ASC);
GO
